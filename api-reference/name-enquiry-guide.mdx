...
description: 'How to validate Nigerian bank account details before creating quotes'
---

# Name Enquiry for NGN Accounts

Name enquiry allows you to validate Nigerian bank account details before creating a quote. This helps ensure payments are sent to the correct recipient and reduces failed transactions.
...
Get all Nigerian banks with their NIP bank codes.
...
|-----------|------|----------|-------------|
| `country` | string | Yes | Must be `"NG"` for Nigeria |
...
| `bankCode` | string | Yes | NIP bank code from the bank list |
