...
| `accountName` | string | Yes | Name associated with the M-Pesa account |
...
<Tip>
  You can validate the paybill business name using the [KES Identifier Validation endpoint](#kes-identifier-validation).
</Tip>
...
<Tip>
  You can validate the till business name using the [KES Identifier Validation endpoint](#kes-identifier-validation).
</Tip>
