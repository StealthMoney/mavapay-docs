...
<Card title="Payment Link API Reference" icon="link" href="/api-reference/endpoint/payment-link/create-payment-link">
...
- [Create Payment Link API](/api-reference/endpoint/payment-link/create-payment-link) - Payment Link API reference
