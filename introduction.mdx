...
Regardless of whether you are a developer or a business, a startup or enterprise, Mavapay API is for you. With Mavapay, you can accept payments from customers in Bitcoin, USDT, or local currency, 
...
<CardGroup cols={2}>
  ...
  <Card
    title="USDT Wallet"
    icon="coins"
    href="/stablecoins/introduction"
  >
    Deposit and withdraw USDT on Tron, Ethereum, Plasma, Solana, and Polygon
  </Card>
</CardGroup>
